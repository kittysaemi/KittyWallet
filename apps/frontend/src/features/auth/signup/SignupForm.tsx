...
const signupSchema = z
  .object({
    ...
    nickname: z.string().min(1, "닉네임을 입력해주세요.").max(30, "닉네임은 30자 이하여야 합니다.")
  })
...
export const SignupForm: React.FC = () => {
  ...
  const getServerError = (): string | null => {
    ...
    const axiosError = signupMutation.error as AxiosError<{ error: ApiError }>;
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4" noValidate>
      ...
      <Input
        ...
        onChange={handleChange}
        placeholder="닉네임을 입력해주세요. (30자 이하)"
      ...
      <Button type="submit" fullWidth isLoading={signupMutation.isPending} className="mt-2">
        회원가입
      </Button>
